...
Planner faction-truth blind-spot cleanup: close remaining faction-specific counter/recommendation drift, including the residual Allied vehicle-counter gap Xi called out, before widening doctrine tables again.
