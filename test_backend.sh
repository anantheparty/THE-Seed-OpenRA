...
echo "  see docs/live_e2e_checklist.md"
echo "  or run the standard live chain:"
echo "    python3 tests/test_live_e2e.py phase_a"
echo "    python3 tests/test_live_e2e.py phase_b"
echo "    python3 tests/test_live_e2e.py phase_c"
echo "    python3 tests/test_live_e2e.py phase_d"
echo "    python3 tests/test_live_e2e.py phase_e"
